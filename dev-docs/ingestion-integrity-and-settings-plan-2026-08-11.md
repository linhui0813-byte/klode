...
> record; **[plan v2](ingestion-integrity-plan-v2-2026-08-11.md) is what to build.** The three
> findings that change the design rather than refine it:
>
...
**The plan that supersedes this one:**
[`ingestion-integrity-plan-v2-2026-08-11.md`](ingestion-integrity-plan-v2-2026-08-11.md).
This document is kept as the record of what was proposed and why it was wrong — the refutation is
the useful part, and a plan quietly rewritten teaches nothing.
