...
check is lodlib's, not ours: we call the same literal-grep verifier the citation-rot linter uses.
"""
...
from lode import lib   # the public facade — this package never reaches into lodlib internals
